...
\newcommand{\myDegree}{Doctora en Tecnologías de la Información y la Comunicación\xspace}
...
\newcommand{\myDirectorOne}{María Isabel García Arenas}
\newcommand{\myDirectorTwo}{Pablo García Sánchez}
\newcommand{\mySupervisor}{Prof. Dr. Dª. \myDirectorOne\\Prof. Dr. D. \myDirectorTwo}
...
\definecolor[named]{darkGreen}{rgb}{.322,.439,.247} % {R:82, G:112, B:63}

\definecolor[named]{minimumOrange}{rgb}{1,.976,.474}
\definecolor[named]{minimumGreen}{rgb}{.698,.906,.624} % {R:178, G:231, B:159}
...
\ifthenelse{\equal{\value{IncluyeCapitulo}}{2}}{\include{Chapters/02-byodSotA}}{\myChapter{Corporate Security Solutions for BYOD}\label{chap:byodSotA}}
...
\ifthenelse{\equal{\value{IncluyeCapitulo}}{2}}{\include{Chapters/03-softc}}{\myChapter{Soft computing techniques applied to classification}\label{chap:softc}}
\ifthenelse{\equal{\value{IncluyeCapitulo}}{2}}{\include{Chapters/04-methodology}}{\myChapter{A methodology for obtaining rules in BYOD environments}\label{chap:methodology}}
...
\ifthenelse{\equal{\value{IncluyeCapitulo}}{2}}{\include{Chapters/05-urls}}{\myChapter{Going a Step Beyond the Black and White Lists for URL Accesses in the Enterprise by Means of Categorical Classifiers}\label{chap:urls}}
\ifthenelse{\equal{\value{IncluyeCapitulo}}{2}}{\include{Chapters/06-musesdata}}{\myChapter{Applying Soft Computing Techniques to Corporate Mobile Security Systems}\label{chap:musesdata}}
...
\appendix
\myPart{Appendix}
\include{Chapters/appendixmuses}
