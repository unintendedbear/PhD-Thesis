...
\ifthenelse{\equal{\value{IncluyeCapitulo}}{2}}{\include{Chapters/04-soaea}}{\myChapter{A methodology for obtaining rules in BYOD environments}\label{chap:methodology}}
