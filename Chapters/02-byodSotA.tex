...
% for later  \cite{Garba15organisational}  \cite{lennon2012changing}

\subsection{Data usage and privacy}

Information privacy, for both the companies' clients and employees, is an important issue brought by the adoption of BYOD \cite{Garba15organisational}. % for later \cite{Clifton1996} \cite{Miller12Privacy}
